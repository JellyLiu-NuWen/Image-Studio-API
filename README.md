...
桌面端支持从配套提示词聚合站 [**Image-Prompts**](https://prompts.sorry.ink/) 一键导入提示词。相关导入说明见 [docs/prompt-import.md](./docs/prompt-import.md)。
...
| Image-Prompts 提示词导入说明 | [docs/prompt-import.md](./docs/prompt-import.md) |
