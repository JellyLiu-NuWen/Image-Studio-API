...
export function WorkspaceBar() {
  ...
  return (
    <div className={`drag-region flex items-center overflow-x-auto border-b border-[var(--border)] bg-[var(--toolbar)] backdrop-blur-2xl ${usesAppleUI ? "liquid-glass-bar" : ""} ${isWindows ? "gap-1 px-3 py-1.5" : isMac ? "mac-workspace-bar gap-1.5 py-1.5" : "gap-1 px-4 py-1.5"}`}>
      {workspaces.map((w) => {
